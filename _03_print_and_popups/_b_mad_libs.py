...
if __name__ == '__main__':
    ...
    liquid = simpledialog.askstring(prompt="enter a liquid",title="liquid")
    # Get the player to enter a body part
    bodypart = simpledialog.askstring(prompt="enter a bodypart",title="bodypart")
    # Get the player to enter a verb
    verb = simpledialog.askstring(prompt="enter a verb",title="verb")
    # Get the player to enter a place
    place = simpledialog.askstring(prompt="enter a place",title="place")
    ...
    story = (
        ...
        "night. Piranhas are attracted to fresh " + liquid + " will most\n"
    ...
    messagebox.showinfo(title="",message=story)
